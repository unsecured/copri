...
void gcd_ppi_ppo(mpz_t gcd, mpz_t ppi, mpz_t ppo, const mpz_t a, const mpz_t c);
...
void prod(mpz_ptr rot, mpz_t * array, size_t from, size_t to);

void array_prod(mpz_array *a, mpz_ptr rot);
